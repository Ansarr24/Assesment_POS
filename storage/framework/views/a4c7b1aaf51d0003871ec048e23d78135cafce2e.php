...
<form action="<?php echo e(route('purchase.store')); ?>" method="POST" style="width: 700px; " >
    <?php echo csrf_field(); ?>
            ...
            <div class="col-md-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <a href="<?php echo e(route('purchase.list')); ?>" class="btn btn-primary"
                            style=" margin: 1%">Go to Next Assesment</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\assesment-1\resources\views/purchase-index.blade.php ENDPATH**/ ?>